            ...
            <div class="grid md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
                <div class="animate-fade-in-up">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 flex-wrap">
                        ...
                        <button class="bg-white text-primary-red border-2 border-primary-red px-6 sm:px-8 py-2.5 sm:py-3.5 rounded-lg text-sm sm:text-base font-semibold hover:bg-gray-100 transition-colors duration-300">Learn More</button>
                    </div>
                </div>
    ...
    <section id="features" class="py-12 sm:py-16 md:py-24 bg-white">
        <div class="max-w-6xl mx-auto px-4 sm:px-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                <div class="bg-white p-6 sm:p-8 md:p-10 rounded-2xl text-center transition-all duration-300 border-2 border-gray-200 hover:-translate-y-2 hover:shadow-xl hover:shadow-red-500/15 hover:border-primary-red">
    ...
    <section id="how-it-works" class="py-12 sm:py-16 md:py-24 bg-gray-100">
        <div class="max-w-6xl mx-auto px-4 sm:px-5">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center flex-wrap gap-6 sm:gap-8 mt-8 sm:mt-12 md:mt-16">
                <div class="flex-1 min-w-[200px] text-center p-4 sm:p-6 md:p-8 bg-white rounded-2xl transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-5">
            <div class="grid md:grid-cols-2 gap-16 items-center">
                ...
                <div class="flex justify-center">
                    <div class="bg-gradient-to-br from-primary-red to-primary-red-dark p-6 sm:p-8 md:p-12 rounded-3xl text-white shadow-2xl shadow-red-500/30 w-full max-w-md transition-transform duration-300 hover:scale-105">
