...
<body class="font-sans text-gray-900 bg-gray-50 min-h-screen">
    ...
    <main class="max-w-7xl mx-auto px-5 py-8">
        ...
        <div class="bg-gradient-to-br from-primary-red to-primary-red-dark rounded-2xl p-8 text-white mb-8 animate-fade-in-up shadow-xl">
            <h1 class="text-4xl font-bold mb-2">Welcome back, <?php echo htmlspecialchars($user['full_name'] ?? 'Guard'); ?>!</h1>
            <p class="text-lg opacity-90">Monitor vehicle registrations and manage campus security</p>
        </div>

        <!-- User Information Card -->
        <div class="bg-white rounded-2xl shadow-lg p-8 mb-8 animate-fade-in-up">
            <h2 class="text-2xl font-bold text-gray-900 mb-6">Guard Information</h2>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 animate-fade-in-up">
            ...
            <div class="flex flex-wrap gap-4">
                <a href="../index.php" class="bg-gray-100 text-gray-900 px-6 py-3 rounded-lg font-semibold hover:bg-gray-200 transition-colors duration-300">
                    ← Back to Homepage
                </a>
                <button class="bg-primary-red text-white px-6 py-3 rounded-lg font-semibold hover:bg-primary-red-dark transition-colors duration-300">
                    Launch Scanner
                </button>
                <button class="bg-white text-primary-red border-2 border-primary-red px-6 py-3 rounded-lg font-semibold hover:bg-gray-50 transition-colors duration-300">
                    View Reports
                </button>
            </div>
        </div>
